...
<head>
	...
	<style>
		...
		/* CSS untuk memperbesar ukuran popup */
		.leaflet-control-geocoder-alternatives {
				font-size: 30px !important; /* Ubah ukuran font sesuai kebutuhan */
		}

		.leaflet-control-geocoder-alternatives-item {
				font-size: 30px !important; /* Ukuran font alternatif jika diperlukan */
		}

		.leaflet-search-error-text {
    	font-size: 100pt !important; /* Ubah ukuran font sesuai kebutuhan */
		}
		...
		.leaflet-control-search .search-alert {
			...
			background-color: #E0E0E0; /* Menambahkan background warna putih */
		}
...
//Function to filter markers based on selected value
function filterMarkers(selectedValue) {
...
var controlSearch = new L.Control.Search({
    ...
    textErr: 'Location Not Found', // Menghilangkan teks notifikasi
});
...
controlSearch.on('search:locationnotfound', function() {
    ...
    alertDiv.className = 'leaflet-control-search search-alert';
    alertDiv.innerHTML = 'Lokasi tidak ditemukan';
    document.querySelector('.leaflet-top.leaflet-left').appendChild(alertDiv);

    // Menghilangkan pop-up setelah 10 detik
    setTimeout(function() {
        alertDiv.style.display = 'none';
    }, 900000); // Waktu dalam milidetik (10000 ms = 10 detik)
});
