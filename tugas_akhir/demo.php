										...
										<div class="select-wrap">
											<div class="icon"><span class="fa fa-chevron-down"></span></div>
												<select name="" id="filter" class="form-control form-control-sm col-lg-4 col-md-6 col-sm-8 col-12">
													...
													<option value="cafe dan eatery">cafe dan eatery</option>
...
<?php
include "koneksi.php";
$query =  mysqli_query($koneksi, "SELECT CONCAT('[',latitude,',',longitude,']') as loc, nama as title, nama, gambar, kategori, jam_buka, rate, kisaran_harga, latitude, longitude, redirect_link FROM `tb_demo`;"); 
$data = []; 
...
function filterMarkers(selectedValue) {
  ...
  data.forEach(function(d) {
    ...
    let jarak = map.distance(map.getCenter(), [d.latitude, d.longitude]);
    if (jarak < rad) {
    ...
    if (selectedValue === 'all' || d.kategori === selectedValue) {
		...
		'<br>' + jarak.toFixed(0)  + ' m' + '<br> <a href="' + d.redirect_link + '" target="_blank">Details</a>');
